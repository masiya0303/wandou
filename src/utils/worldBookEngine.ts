...
export const PRESET_WORLD_BOOK: WorldBookEntry[] = [
  {
    ...
    comment: '银河星盟',
    enabled: true, priority: 80, position: 'after',
  },
  {
    id: 'preset-002',
    keys: ['虫族', '异虫', '虫群', '虫潮'],
    ...
    comment: '虫族威胁',
    enabled: true, priority: 85, position: 'after',
  },
  {
    id: 'preset-003',
    ...
    comment: '曲速引擎',
    enabled: true, priority: 70, position: 'after',
  },
  {
    id: 'preset-004',
    keys: ['暗物质', '暗能量', '黑晶', '暗晶'],
    ...
    comment: '暗物质能源',
    enabled: true, priority: 75, position: 'after',
  },
  {
    id: 'preset-005',
    keys: ['豌豆号', '飞船', '舰船'],
    ...
    comment: '豌豆号',
    enabled: true, priority: 90, position: 'at_constant',
  },
  {
    id: 'preset-006',
    keys: ['海盗', '掠夺者', '走私', '地下市场'],
    ...
    comment: '星际海盗',
    enabled: true, priority: 65, position: 'after',
  },
  {
    id: 'preset-007',
    keys: ['星门', '传送门', '跳转', 'gate'],
  ...
  },
  {
    ...
    comment: 'AI 与合成体',
    enabled: true, priority: 60, position: 'after',
  },
]
