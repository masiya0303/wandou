...
/* bar */
.bar { display: flex; align-items: center; justify-content: space-evenly; height: 48px; flex-shrink: 0; z-index: 20; background: var(--pink-bubble-bg); border-top: 1px solid var(--pink-ice); }
.tb { display: flex; flex-direction: column; align-items: center; gap: 1px; border: none; background: none; color: var(--pink-primary); cursor: pointer; font-family: inherit; padding: 4px 12px; border-radius: 8px; transition: all 0.15s; opacity: 0.6; }
.tb.on { color: var(--pink-accent); background: rgba(255,128,168,0.08); opacity: 1; }
.tb:active { transform: scale(0.94); }
.tb-ico { font-size: 16px; }
.tb-txt { font-size: 10px; font-weight: 500; }

/* shared */
.none { text-align: center; padding: 32px 16px; color: var(--pink-primary); font-size: 13px; opacity: 0.6; }
.cat { margin-bottom: 8px; }
.cat-head { font-size: 12px; font-weight: 600; color: var(--pink-accent); margin-bottom: 4px; display: flex; align-items: baseline; gap: 4px; }
.cat-n { font-size: 11px; color: var(--pink-primary); font-weight: 400; opacity: 0.6; }
.inv-item { display: flex; align-items: center; gap: 6px; padding: 6px 10px; border-radius: 8px; background: rgba(255,182,193,0.1); margin-bottom: 3px; font-size: 13px; }
.inv-name { color: var(--pink-primary); font-weight: 500; }
.inv-qty { color: var(--pink-accent); font-size: 11px; }
...
.card-name { font-size: 13px; font-weight: 600; color: var(--pink-primary); }
.card-sub { font-size: 11px; color: var(--pink-accent); }
.card-text { font-size: 12px; color: var(--pink-primary); opacity: 0.7; margin: 0; line-height: 1.4; }
</style>
