...
.ex-fill { flex: 1; min-height: 0; overflow: hidden; padding: 12px; border-radius: 16px; background: rgba(255,255,255,0.55); border: 1px solid var(--theme-border-ice); display: flex; flex-direction: column; }
